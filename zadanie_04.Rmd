...
```
# Wykres tygodniowej generacji zrodel wiatrowych i fotowoltaicznych 


```{r, echo=F, results="asis", fig.height=5, fig.width=10, fig.cap=" "}
library(reshape)
library(lattice)
library(ggplot2)
    library(ggplot2)
...
# Tabela generacji zrodel wiatrowych i fotowoltaicznych
